...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>${variables.name ? variables.name : "Amanda"} ${
    variables.lastName ? variables.lastName : "Whatson"
  }</h1>
          ...
          <ul class="${variables.socialMediaPosition}">
            <li><a ${
              variables.twitter
                ...
                : ""
            }" target='_blanck'><i class="fab fa-twitter"></i></a></li>

            <li><a ${
              variables.github
                ? `href = "https://github.com/${variables.github}"`
                : ""
            }" target='_blanck'><i class="fab fa-github"></i></a></li>
            ...
            <li><a ${
              variables.linkedin
                ...
                : ""
            }" target='_blanck'><i class="fab fa-linkedin"></i></a></li>
            <li><a ${
              variables.instagram
                ? `href = "https://instagram.com/${variables.instagram}"`
                : ""
            }" target='_blanck'><i class="fab fa-instagram"></i></a></li>
          </ul>
        </div>
    `;
}
